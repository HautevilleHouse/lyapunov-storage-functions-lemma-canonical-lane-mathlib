import LyapunovStorageFunctionsLemmaCanonicalLaneLean.PerelmanEntropy
...
structure NoncollapsingEvidence {G : RiemannianCurvaturePackage}
    {F : RicciFlowPDEPackage G} {S : ShortTimeExistencePackage F}
    {Epkg : LyapunovStorageFunctionsPackage S} (N : NoncollapsingPackage Epkg) where
...
def NoncollapsingClosed {G : RiemannianCurvaturePackage}
    {F : RicciFlowPDEPackage G} {S : ShortTimeExistencePackage F}
    {Epkg : LyapunovStorageFunctionsPackage S} (N : NoncollapsingPackage Epkg) : Prop :=
